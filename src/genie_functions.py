...
from .functions import get_workspace_client
from .config import get_raw_configs
...
def run_genie(prompt: str) -> str:
    ...
    try:
        ...
        w = get_workspace_client('user')
        genie_space_id = get_raw_configs()['genie_space_id']
        sleeper_time = 0.7 
        max_retries =  45
